...
public class RabbitMQTopicsConfig {
	...
	Binding bindingSportsNewsQueue(@Qualifier("soprtsNewsQueue") Queue sportsNewsQueue, 
								   @Qualifier("newsExchange") TopicExchange newsExchange) {
	...
	Binding bindingTechNewsQueue(@Qualifier("techNewsQueue") Queue techNewsQueue, 
								 @Qualifier("newsExchange") TopicExchange newsExchange) {
